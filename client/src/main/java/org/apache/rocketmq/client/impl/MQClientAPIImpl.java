...
public class MQClientAPIImpl {
    ...
    public SendResult sendMessage(final String addr, final String brokerName, final Message msg, final SendMessageRequestHeader requestHeader, final long timeoutMillis,
        final CommunicationMode communicationMode, final SendMessageContext context, final DefaultMQProducerImpl producer
    ...
    public SendResult sendMessage(
        ...
        if (sendSmartMsg || msg instanceof MessageBatch) {
            //MessageBatch  320  SendMessageRequestHeaderV2
            //Message       310  SendMessageRequestHeaderV2
            SendMessageRequestHeaderV2 requestHeaderV2 = SendMessageRequestHeaderV2.createSendMessageRequestHeaderV2(requestHeader);
            request = RemotingCommand.createRequestCommand(msg instanceof MessageBatch ? RequestCode.SEND_BATCH_MESSAGE : RequestCode.SEND_MESSAGE_V2, requestHeaderV2);
        } else {
            //Message       10   SendMessageRequestHeader
    ...
    private PullResult processPullResponse(final RemotingCommand response) throws MQBrokerException, RemotingCommandException {
        ...
        switch (response.getCode()) {
            ...
            default: throw new MQBrokerException(response.getCode(), response.getRemark());
        }
    ...
    //发送心跳时，会将当前MQClientInsatance所有的生产者和消费者的信息(尤其是groupName)带过去
    ...
    public QueryConsumeQueueResponseBody queryConsumeQueue(final String brokerAddr, final String topic, final int queueId, final long index, final int count, final String consumerGroup, final long timeoutMillis) throws InterruptedException,
